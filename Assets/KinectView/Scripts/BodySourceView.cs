...
public class BodySourceView : MonoBehaviour 
{
    ...
    private void Start()
    {
        body = GameObject.FindGameObjectWithTag("Body").GetComponent<GameObject>();
    }
    void Update () 
    {
    ...
    {
        GameObject body = new GameObject("BodyKinect");
    ...
    {
        Vector3 posCam = Camera.main.transform.position;
        return new Vector3(joint.Position.X * 50 + posCam.x, joint.Position.Y * 50 + posCam.y, joint.Position.Z * 10);
    }
